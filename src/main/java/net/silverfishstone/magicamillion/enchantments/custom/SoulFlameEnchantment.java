...
public class SoulFlameEnchantment extends Enchantment {
    public SoulFlameEnchantment(Rarity pRarity, EnchantmentCategory pCategory, EquipmentSlot... pApplicableSlots) {
    ...
    public void doPostAttack(LivingEntity pAttacker, Entity pTarget, int pLevel) {
        ...
        target.setSecondsOnFire(pLevel * 4);
        target.addEffect(new MobEffectInstance(ModdedMobEffects.SOUL_FLAME.get(), pLevel * 80, 0, true, false));
    }
